# Generated by Powerlevel10k configuration wizard on 2019-08-05 at 11:02 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 34533.
# Wizard options: awesome-fontconfig + powerline, large icons, lean, 1 line, compact,
# many icons, concise.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_SHORTEN_MIN_LENGTH=0
