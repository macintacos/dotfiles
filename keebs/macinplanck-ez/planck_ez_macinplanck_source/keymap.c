...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(MT(MOD_MEH, KC_TAB),KC_Q,KC_W,KC_E,KC_R,KC_T,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSPACE,LCTL_T(KC_LGUI),KC_A,KC_S,KC_D,KC_F,KC_G,KC_H,KC_J,KC_K,KC_L,KC_SCOLON,KC_QUOTE,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_N,KC_M,KC_COMMA,KC_DOT,KC_SLASH,KC_ENTER,TG(4),KC_LCTRL,KC_LALT,OSM(MOD_LGUI),TT(1),KC_SPACE,KC_NO,TT(2),KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT),

  [_LOWER] = LAYOUT_planck_grid(KC_GRAVE,KC_1,KC_2,KC_3,KC_4,KC_5,KC_6,KC_7,KC_8,KC_9,KC_0,KC_BSPACE,TO(0),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_MINUS,KC_EQUAL,KC_LBRACKET,KC_RBRACKET,KC_BSLASH,KC_LSHIFT,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_ENTER,KC_NO,KC_LCTRL,KC_LALT,OSM(MOD_LGUI),KC_NO,LGUI(KC_SPACE),KC_NO,KC_NO,KC_MEDIA_PLAY_PAUSE,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_AUDIO_MUTE),

  [_RAISE] = LAYOUT_planck_grid(KC_TILD,KC_EXLM,KC_AT,KC_HASH,KC_DLR,KC_PERC,KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,KC_BSPACE,TO(0),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_UNDS,KC_PLUS,KC_LCBR,KC_RCBR,KC_PIPE,KC_LSHIFT,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_ENTER,KC_NO,KC_LCTRL,KC_LALT,OSM(MOD_LGUI),KC_NO,RGUI(KC_SPACE),KC_NO,KC_NO,KC_MEDIA_PLAY_PAUSE,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_AUDIO_MUTE),

  [_ADJUST] = LAYOUT_planck_grid(KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,TO(0),KC_NO,AU_ON,AU_OFF,AU_TOG,KC_NO,KC_NO,RGB_TOG,RGB_VAI,RGB_VAD,KC_NO,RESET,KC_NO,KC_NO,MU_ON,MU_OFF,MU_TOG,KC_NO,KC_NO,RGB_MOD,RGB_HUI,RGB_HUD,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_TRANSPARENT),
  ...
  [_LAYER6] = LAYOUT_planck_grid(KC_NO,KC_NO,LALT(KC_RIGHT),LALT(KC_RIGHT),KC_NO,KC_NO,KC_NO,KC_NO,LGUI(KC_LEFT),KC_NO,LGUI(KC_P),KC_BSPACE,KC_NO,LGUI(KC_RIGHT),KC_NO,KC_NO,KC_NO,LGUI(KC_DOWN),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_TRANSPARENT,KC_NO,KC_BSPACE,KC_NO,KC_NO,LALT(KC_LEFT),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_ENTER,KC_NO,KC_LCTRL,KC_LALT,OSM(MOD_LGUI),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO),
