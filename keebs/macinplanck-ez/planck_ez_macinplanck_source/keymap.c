...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LAYER5] = LAYOUT_planck_grid(KC_NO,KC_NO,LALT(LSFT(KC_RIGHT)),LALT(LSFT(KC_RIGHT)),KC_NO,KC_NO,LGUI(KC_C),KC_NO,TO(0),KC_NO,LGUI(KC_V),LSFT(KC_LEFT),TO(0),TO(0),KC_NO,LGUI(KC_X),KC_NO,KC_NO,LSFT(KC_LEFT),LSFT(KC_DOWN),LSFT(KC_UP),LSFT(KC_RIGHT),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,TO(0),KC_TRANSPARENT,LALT(LSFT(KC_LEFT)),KC_NO,KC_NO,LSFT(KC_TAB),KC_TAB,KC_NO,LSFT(KC_DOWN),TO(4),KC_LCTRL,KC_LALT,OSM(MOD_LGUI),DYN_REC_START1,DYN_MACRO_PLAY1,KC_NO,DYN_REC_START1,MO(8),KC_NO,KC_NO,TG(7)),
